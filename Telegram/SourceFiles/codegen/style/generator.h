...
private:
	...
	std::vector<int> _scales = { 4, 5, 6, 7, 8 }; // scale / 4 gives our 1.00, 1.25, 1.50, 1.75, 2.00
	std::vector<const char *> _scaleNames = { "dbisOne", "dbisOneAndQuarter", "dbisOneAndHalf", "dbisOneSevenFive", "dbisTwo" };
