...
namespace Dialogs
{
		...
		, _scrollToTop(_scroll, st::dialogsToUp)
	{
		...
		_chooseFromUser->entity()->setClickedCallback([this]
		{
			showSearchFrom();
		});
		...
		_mainMenuToggle->setClickedCallback([this]
		{
			showMainMenu();
		});
	...
	void Widget::startSlideAnimation()
	{
		...
		{
			animationCallback();
		}, 0., 1., st::slideDuration, Window::SlideAnimation::transition());
	}
