...
namespace Info
{
	namespace Media
	{
		...
		inline auto MediaTextPhrase(Type type)
		{
			...
			{
			case Type::Photo:
				return lng_profile_photos;
			case Type::Video:
				return lng_profile_videos;
			case Type::File:
				return lng_profile_files;
			case Type::MusicFile:
				return lng_profile_songs;
			case Type::Link:
				return lng_profile_shared_links;
			case Type::RoundVoiceFile:
				return lng_profile_audios;
			}
