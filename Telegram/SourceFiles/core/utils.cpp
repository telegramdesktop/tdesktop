...
QString translitLetterRusEng(QChar letter, QChar next, int32 &toSkip) {
	if (fastDoubleLetterRusEng.isEmpty()) {
		fastDoubleLetterRusEng.insert((QStringLiteral("Ы").at(0).unicode() << 16) | QStringLiteral("й").at(0).unicode(), u"Y"_q);
		fastDoubleLetterRusEng.insert((QStringLiteral("и").at(0).unicode() << 16) | QStringLiteral("я").at(0).unicode(), u"ia"_q);
		fastDoubleLetterRusEng.insert((QStringLiteral("и").at(0).unicode() << 16) | QStringLiteral("й").at(0).unicode(), u"y"_q);
		fastDoubleLetterRusEng.insert((QStringLiteral("к").at(0).unicode() << 16) | QStringLiteral("с").at(0).unicode(), u"x"_q);
		fastDoubleLetterRusEng.insert((QStringLiteral("ы").at(0).unicode() << 16) | QStringLiteral("й").at(0).unicode(), u"y"_q);
		fastDoubleLetterRusEng.insert((QStringLiteral("ь").at(0).unicode() << 16) | QStringLiteral("е").at(0).unicode(), u"ye"_q);
	}
	...
	if (fastLetterRusEng.isEmpty()) {
		fastLetterRusEng.insert(QStringLiteral("А").at(0), u"A"_q);
		fastLetterRusEng.insert(QStringLiteral("Б").at(0), u"B"_q);
		fastLetterRusEng.insert(QStringLiteral("В").at(0), u"V"_q);
		fastLetterRusEng.insert(QStringLiteral("Г").at(0), u"G"_q);
		fastLetterRusEng.insert(QStringLiteral("Ґ").at(0), u"G"_q);
		fastLetterRusEng.insert(QStringLiteral("Д").at(0), u"D"_q);
		fastLetterRusEng.insert(QStringLiteral("Е").at(0), u"E"_q);
		fastLetterRusEng.insert(QStringLiteral("Є").at(0), u"Ye"_q);
		fastLetterRusEng.insert(QStringLiteral("Ё").at(0), u"Yo"_q);
		fastLetterRusEng.insert(QStringLiteral("Ж").at(0), u"Zh"_q);
		fastLetterRusEng.insert(QStringLiteral("З").at(0), u"Z"_q);
		fastLetterRusEng.insert(QStringLiteral("И").at(0), u"I"_q);
		fastLetterRusEng.insert(QStringLiteral("Ї").at(0), u"Yi"_q);
		fastLetterRusEng.insert(QStringLiteral("І").at(0), u"I"_q);
		fastLetterRusEng.insert(QStringLiteral("Й").at(0), u"J"_q);
		fastLetterRusEng.insert(QStringLiteral("К").at(0), u"K"_q);
		fastLetterRusEng.insert(QStringLiteral("Л").at(0), u"L"_q);
		fastLetterRusEng.insert(QStringLiteral("М").at(0), u"M"_q);
		fastLetterRusEng.insert(QStringLiteral("Н").at(0), u"N"_q);
		fastLetterRusEng.insert(QStringLiteral("О").at(0), u"O"_q);
		fastLetterRusEng.insert(QStringLiteral("П").at(0), u"P"_q);
		fastLetterRusEng.insert(QStringLiteral("Р").at(0), u"R"_q);
		fastLetterRusEng.insert(QStringLiteral("С").at(0), u"S"_q);
		fastLetterRusEng.insert(QStringLiteral("Т").at(0), u"T"_q);
		fastLetterRusEng.insert(QStringLiteral("У").at(0), u"U"_q);
		fastLetterRusEng.insert(QStringLiteral("Ў").at(0), u"W"_q);
		fastLetterRusEng.insert(QStringLiteral("Ф").at(0), u"F"_q);
		fastLetterRusEng.insert(QStringLiteral("Х").at(0), u"Kh"_q);
		fastLetterRusEng.insert(QStringLiteral("Ц").at(0), u"Ts"_q);
		fastLetterRusEng.insert(QStringLiteral("Ч").at(0), u"Ch"_q);
		fastLetterRusEng.insert(QStringLiteral("Ш").at(0), u"Sh"_q);
		fastLetterRusEng.insert(QStringLiteral("Щ").at(0), u"Sch"_q);
		fastLetterRusEng.insert(QStringLiteral("Э").at(0), u"E"_q);
		fastLetterRusEng.insert(QStringLiteral("Ю").at(0), u"Yu"_q);
		fastLetterRusEng.insert(QStringLiteral("Я").at(0), u"Ya"_q);
		fastLetterRusEng.insert(QStringLiteral("Ў").at(0), u"W"_q);
		fastLetterRusEng.insert(QStringLiteral("а").at(0), u"a"_q);
		fastLetterRusEng.insert(QStringLiteral("б").at(0), u"b"_q);
		fastLetterRusEng.insert(QStringLiteral("в").at(0), u"v"_q);
		...
		fastLetterRusEng.insert(QStringLiteral("ж").at(0), u"zh"_q);
		fastLetterRusEng.insert(QStringLiteral("з").at(0), u"z"_q);
		fastLetterRusEng.insert(QStringLiteral("й").at(0), u"y"_q);
		fastLetterRusEng.insert(QStringLiteral("ї").at(0), u"yi"_q);
		fastLetterRusEng.insert(QStringLiteral("і").at(0), u"i"_q);
		fastLetterRusEng.insert(QStringLiteral("л").at(0), u"l"_q);
		fastLetterRusEng.insert(QStringLiteral("м").at(0), u"m"_q);
		...
		fastLetterRusEng.insert(QStringLiteral("ш").at(0), u"sh"_q);
		fastLetterRusEng.insert(QStringLiteral("щ").at(0), u"sch"_q);
		fastLetterRusEng.insert(QStringLiteral("ъ").at(0), QString());
		fastLetterRusEng.insert(QStringLiteral("э").at(0), u"e"_q);
		fastLetterRusEng.insert(QStringLiteral("ю").at(0), u"yu"_q);
		fastLetterRusEng.insert(QStringLiteral("я").at(0), u"ya"_q);
		fastLetterRusEng.insert(QStringLiteral("ў").at(0), u"w"_q);
		fastLetterRusEng.insert(QStringLiteral("Ы").at(0), u"Y"_q);
		fastLetterRusEng.insert(QStringLiteral("и").at(0), u"i"_q);
		fastLetterRusEng.insert(QStringLiteral("к").at(0), u"k"_q);
		fastLetterRusEng.insert(QStringLiteral("ы").at(0), u"y"_q);
		fastLetterRusEng.insert(QStringLiteral("ь").at(0), QString());
	}
...
QString translitRusEng(const QString &rus) {
	if (fastRusEng.isEmpty()) {
		fastRusEng.insert(QStringLiteral("Александр"), u"Alexander"_q);
		fastRusEng.insert(QStringLiteral("александр"), u"alexander"_q);
		fastRusEng.insert(QStringLiteral("Филипп"), u"Philip"_q);
		fastRusEng.insert(QStringLiteral("филипп"), u"philip"_q);
		fastRusEng.insert(QStringLiteral("Пётр"), u"Petr"_q);
		fastRusEng.insert(QStringLiteral("пётр"), u"petr"_q);
		fastRusEng.insert(QStringLiteral("Гай"), u"Gai"_q);
		fastRusEng.insert(QStringLiteral("гай"), u"gai"_q);
		fastRusEng.insert(QStringLiteral("Ильин"), u"Ilyin"_q);
		fastRusEng.insert(QStringLiteral("ильин"), u"ilyin"_q);
	}
