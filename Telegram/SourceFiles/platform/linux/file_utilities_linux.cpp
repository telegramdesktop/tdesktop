...
namespace Platform
{
	...
	namespace FileDialog
	{
		...
		namespace internal
		{
			QGtkDialog::QGtkDialog(GtkWidget* gtkWidget) :
				gtkWidget(gtkWidget)
			{
...
#ifndef TDESKTOP_DISABLE_GTK_INTEGRATION
			GtkFileDialog::GtkFileDialog(QWidget* parent, const QString& caption, const QString& directory, const QString& filter) :
				QDialog(parent)
