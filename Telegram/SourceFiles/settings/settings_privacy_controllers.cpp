...
namespace Settings
{
	...
	QString PhoneNumberPrivacyController::exceptionBoxTitle(Exception exception)
	{
		...
		{
		case Exception::Always:
			return lang(lng_edit_privacy_phone_number_always_title);
		case Exception::Never:
			return lang(lng_edit_privacy_phone_number_never_title);
		}
		Unexpected("Invalid exception value.");
	}
	...
	QString LastSeenPrivacyController::exceptionBoxTitle(Exception exception)
	{
		...
		{
		case Exception::Always:
			return lang(lng_edit_privacy_lastseen_always_title);
		case Exception::Never:
			return lang(lng_edit_privacy_lastseen_never_title);
		}
		Unexpected("Invalid exception value.");
	}
		...
		Exception exception)
	{
		...
		{
		case Exception::Always:
			return lng_edit_privacy_groups_always_empty;
		case Exception::Never:
			return lng_edit_privacy_groups_never_empty;
		}
		Unexpected("Invalid exception value.");
	}
	...
	QString GroupsInvitePrivacyController::exceptionBoxTitle(Exception exception)
	{
		...
		{
		case Exception::Always:
			return lang(lng_edit_privacy_groups_always_title);
		case Exception::Never:
			return lang(lng_edit_privacy_groups_never_title);
		}
		Unexpected("Invalid exception value.");
	}
		...
		Exception exception)
	{
		...
		{
		case Exception::Always:
			return lng_edit_privacy_calls_always_empty;
		case Exception::Never:
			return lng_edit_privacy_calls_never_empty;
		}
		Unexpected("Invalid exception value.");
	}
	...
	QString CallsPrivacyController::exceptionBoxTitle(Exception exception)
	{
		...
		{
		case Exception::Always:
			return lang(lng_edit_privacy_calls_always_title);
		case Exception::Never:
			return lang(lng_edit_privacy_calls_never_title);
		}
		Unexpected("Invalid exception value.");
	}
		...
		Exception exception)
	{
		...
		{
		case Exception::Always:
			return lng_edit_privacy_calls_p2p_always_empty;
		case Exception::Never:
			return lng_edit_privacy_calls_p2p_never_empty;
		}
		Unexpected("Invalid exception value.");
	}
	...
	QString CallsPeer2PeerPrivacyController::exceptionBoxTitle(Exception exception)
	{
		...
		{
		case Exception::Always:
			return lang(lng_edit_privacy_calls_p2p_always_title);
		case Exception::Never:
			return lang(lng_edit_privacy_calls_p2p_never_title);
		}
		Unexpected("Invalid exception value.");
	}
		...
		Exception exception)
	{
		...
		{
		case Exception::Always:
			return lng_edit_privacy_forwards_always_empty;
		case Exception::Never:
			return lng_edit_privacy_forwards_never_empty;
		}
		Unexpected("Invalid exception value.");
	}
	...
	QString ForwardsPrivacyController::exceptionBoxTitle(Exception exception)
	{
		...
		{
		case Exception::Always:
			return lang(lng_edit_privacy_forwards_always_title);
		case Exception::Never:
			return lang(lng_edit_privacy_forwards_never_title);
		}
		Unexpected("Invalid exception value.");
	}
		...
		Exception exception)
	{
		...
		{
		case Exception::Always:
			return lng_edit_privacy_profile_photo_always_empty;
		case Exception::Never:
			return lng_edit_privacy_profile_photo_never_empty;
		}
		Unexpected("Invalid exception value.");
	}
	...
	QString ProfilePhotoPrivacyController::exceptionBoxTitle(Exception exception)
	{
		...
		{
		case Exception::Always:
			return lang(lng_edit_privacy_profile_photo_always_title);
		case Exception::Never:
			return lang(lng_edit_privacy_profile_photo_never_title);
		}
		Unexpected("Invalid exception value.");
	}
