...
namespace {
	...
	void initLinkSets() {
		...
		regOneTopDomain(qsl("abogado"));
		regOneTopDomain(qsl("academy"));
		regOneTopDomain(qsl("accountants"));
		regOneTopDomain(qsl("active"));
		regOneTopDomain(qsl("actor"));
		regOneTopDomain(qsl("adult"));
		regOneTopDomain(qsl("aero"));
		regOneTopDomain(qsl("agency"));
		regOneTopDomain(qsl("airforce"));
		regOneTopDomain(qsl("allfinanz"));
		regOneTopDomain(qsl("alsace"));
		regOneTopDomain(qsl("amsterdam"));
		regOneTopDomain(qsl("android"));
		regOneTopDomain(qsl("apartments"));
		regOneTopDomain(qsl("aquarelle"));
		regOneTopDomain(qsl("archi"));
		regOneTopDomain(qsl("army"));
		regOneTopDomain(qsl("arpa"));
		regOneTopDomain(qsl("asia"));
		regOneTopDomain(qsl("associates"));
		regOneTopDomain(qsl("attorney"));
		regOneTopDomain(qsl("auction"));
		regOneTopDomain(qsl("audio"));
		regOneTopDomain(qsl("autos"));
		regOneTopDomain(qsl("axa"));
		regOneTopDomain(qsl("band"));
		regOneTopDomain(qsl("bank"));
		regOneTopDomain(qsl("bar"));
		regOneTopDomain(qsl("barclaycard"));
		regOneTopDomain(qsl("barclays"));
		regOneTopDomain(qsl("bargains"));
		regOneTopDomain(qsl("bayern"));
		regOneTopDomain(qsl("beer"));
		regOneTopDomain(qsl("berlin"));
		regOneTopDomain(qsl("best"));
		regOneTopDomain(qsl("bid"));
		regOneTopDomain(qsl("bike"));
		regOneTopDomain(qsl("bingo"));
		regOneTopDomain(qsl("bio"));
		regOneTopDomain(qsl("biz"));
		regOneTopDomain(qsl("black"));
		regOneTopDomain(qsl("blackfriday"));
		regOneTopDomain(qsl("bloomberg"));
		regOneTopDomain(qsl("blue"));
		regOneTopDomain(qsl("bmw"));
		regOneTopDomain(qsl("bnpparibas"));
		regOneTopDomain(qsl("boo"));
		regOneTopDomain(qsl("boutique"));
		regOneTopDomain(qsl("brussels"));
		regOneTopDomain(qsl("budapest"));
		regOneTopDomain(qsl("build"));
		regOneTopDomain(qsl("builders"));
		regOneTopDomain(qsl("business"));
		regOneTopDomain(qsl("buzz"));
		regOneTopDomain(qsl("bzh"));
		regOneTopDomain(qsl("cab"));
		regOneTopDomain(qsl("cal"));
		regOneTopDomain(qsl("camera"));
		regOneTopDomain(qsl("camp"));
		regOneTopDomain(qsl("cancerresearch"));
		regOneTopDomain(qsl("canon"));
		regOneTopDomain(qsl("capetown"));
		regOneTopDomain(qsl("capital"));
		regOneTopDomain(qsl("caravan"));
		regOneTopDomain(qsl("cards"));
		regOneTopDomain(qsl("care"));
		regOneTopDomain(qsl("career"));
		regOneTopDomain(qsl("careers"));
		regOneTopDomain(qsl("cartier"));
		regOneTopDomain(qsl("casa"));
		regOneTopDomain(qsl("cash"));
		regOneTopDomain(qsl("casino"));
		regOneTopDomain(qsl("cat"));
		regOneTopDomain(qsl("catering"));
		regOneTopDomain(qsl("cbn"));
		regOneTopDomain(qsl("center"));
		regOneTopDomain(qsl("ceo"));
		regOneTopDomain(qsl("cern"));
		regOneTopDomain(qsl("channel"));
		regOneTopDomain(qsl("chat"));
		regOneTopDomain(qsl("cheap"));
		regOneTopDomain(qsl("christmas"));
		regOneTopDomain(qsl("chrome"));
		regOneTopDomain(qsl("church"));
		regOneTopDomain(qsl("citic"));
		regOneTopDomain(qsl("city"));
		regOneTopDomain(qsl("claims"));
		regOneTopDomain(qsl("cleaning"));
		regOneTopDomain(qsl("click"));
		regOneTopDomain(qsl("clinic"));
		regOneTopDomain(qsl("clothing"));
		regOneTopDomain(qsl("club"));
		regOneTopDomain(qsl("coach"));
		regOneTopDomain(qsl("codes"));
		regOneTopDomain(qsl("coffee"));
		regOneTopDomain(qsl("college"));
		regOneTopDomain(qsl("cologne"));
		regOneTopDomain(qsl("com"));
		regOneTopDomain(qsl("community"));
		regOneTopDomain(qsl("company"));
		regOneTopDomain(qsl("computer"));
		regOneTopDomain(qsl("condos"));
		regOneTopDomain(qsl("construction"));
		regOneTopDomain(qsl("consulting"));
		regOneTopDomain(qsl("contractors"));
		regOneTopDomain(qsl("cooking"));
		regOneTopDomain(qsl("cool"));
		regOneTopDomain(qsl("coop"));
		regOneTopDomain(qsl("country"));
		regOneTopDomain(qsl("credit"));
		regOneTopDomain(qsl("creditcard"));
		regOneTopDomain(qsl("cricket"));
		regOneTopDomain(qsl("crs"));
		regOneTopDomain(qsl("cruises"));
		regOneTopDomain(qsl("cuisinella"));
		regOneTopDomain(qsl("cymru"));
		regOneTopDomain(qsl("dabur"));
		regOneTopDomain(qsl("dad"));
		regOneTopDomain(qsl("dance"));
		regOneTopDomain(qsl("dating"));
		regOneTopDomain(qsl("day"));
		regOneTopDomain(qsl("dclk"));
		regOneTopDomain(qsl("deals"));
		regOneTopDomain(qsl("degree"));
		regOneTopDomain(qsl("delivery"));
		regOneTopDomain(qsl("democrat"));
		regOneTopDomain(qsl("dental"));
		regOneTopDomain(qsl("dentist"));
		regOneTopDomain(qsl("desi"));
		regOneTopDomain(qsl("design"));
		regOneTopDomain(qsl("dev"));
		regOneTopDomain(qsl("diamonds"));
		regOneTopDomain(qsl("diet"));
		regOneTopDomain(qsl("digital"));
		regOneTopDomain(qsl("direct"));
		regOneTopDomain(qsl("directory"));
		regOneTopDomain(qsl("discount"));
		regOneTopDomain(qsl("dnp"));
		regOneTopDomain(qsl("docs"));
		regOneTopDomain(qsl("domains"));
		regOneTopDomain(qsl("doosan"));
		regOneTopDomain(qsl("durban"));
		regOneTopDomain(qsl("dvag"));
		regOneTopDomain(qsl("eat"));
		regOneTopDomain(qsl("edu"));
		regOneTopDomain(qsl("education"));
		regOneTopDomain(qsl("email"));
		regOneTopDomain(qsl("emerck"));
		regOneTopDomain(qsl("energy"));
		regOneTopDomain(qsl("engineer"));
		regOneTopDomain(qsl("engineering"));
		regOneTopDomain(qsl("enterprises"));
		regOneTopDomain(qsl("equipment"));
		regOneTopDomain(qsl("esq"));
		regOneTopDomain(qsl("estate"));
		regOneTopDomain(qsl("eurovision"));
		regOneTopDomain(qsl("eus"));
		regOneTopDomain(qsl("events"));
		regOneTopDomain(qsl("everbank"));
		regOneTopDomain(qsl("exchange"));
		regOneTopDomain(qsl("expert"));
		regOneTopDomain(qsl("exposed"));
		regOneTopDomain(qsl("fail"));
		regOneTopDomain(qsl("fans"));
		regOneTopDomain(qsl("farm"));
		regOneTopDomain(qsl("fashion"));
		regOneTopDomain(qsl("feedback"));
		regOneTopDomain(qsl("finance"));
		regOneTopDomain(qsl("financial"));
		regOneTopDomain(qsl("firmdale"));
		regOneTopDomain(qsl("fish"));
		regOneTopDomain(qsl("fishing"));
		regOneTopDomain(qsl("fit"));
		regOneTopDomain(qsl("fitness"));
		regOneTopDomain(qsl("flights"));
		regOneTopDomain(qsl("florist"));
		regOneTopDomain(qsl("flowers"));
		regOneTopDomain(qsl("flsmidth"));
		regOneTopDomain(qsl("fly"));
		regOneTopDomain(qsl("foo"));
		regOneTopDomain(qsl("football"));
		regOneTopDomain(qsl("forsale"));
		regOneTopDomain(qsl("foundation"));
		regOneTopDomain(qsl("frl"));
		regOneTopDomain(qsl("frogans"));
		regOneTopDomain(qsl("fund"));
		regOneTopDomain(qsl("furniture"));
		regOneTopDomain(qsl("futbol"));
		regOneTopDomain(qsl("gal"));
		regOneTopDomain(qsl("gallery"));
		regOneTopDomain(qsl("garden"));
		regOneTopDomain(qsl("gbiz"));
		regOneTopDomain(qsl("gdn"));
		regOneTopDomain(qsl("gent"));
		regOneTopDomain(qsl("ggee"));
		regOneTopDomain(qsl("gift"));
		regOneTopDomain(qsl("gifts"));
		regOneTopDomain(qsl("gives"));
		regOneTopDomain(qsl("glass"));
		regOneTopDomain(qsl("gle"));
		regOneTopDomain(qsl("global"));
		regOneTopDomain(qsl("globo"));
		regOneTopDomain(qsl("gmail"));
		regOneTopDomain(qsl("gmo"));
		regOneTopDomain(qsl("gmx"));
		regOneTopDomain(qsl("goldpoint"));
		regOneTopDomain(qsl("goog"));
		regOneTopDomain(qsl("google"));
		regOneTopDomain(qsl("gop"));
		regOneTopDomain(qsl("gov"));
		regOneTopDomain(qsl("graphics"));
		regOneTopDomain(qsl("gratis"));
		regOneTopDomain(qsl("green"));
		regOneTopDomain(qsl("gripe"));
		regOneTopDomain(qsl("guide"));
		regOneTopDomain(qsl("guitars"));
		regOneTopDomain(qsl("guru"));
		regOneTopDomain(qsl("hamburg"));
		regOneTopDomain(qsl("hangout"));
		regOneTopDomain(qsl("haus"));
		regOneTopDomain(qsl("healthcare"));
		regOneTopDomain(qsl("help"));
		regOneTopDomain(qsl("here"));
		regOneTopDomain(qsl("hermes"));
		regOneTopDomain(qsl("hiphop"));
		regOneTopDomain(qsl("hiv"));
		regOneTopDomain(qsl("holdings"));
		regOneTopDomain(qsl("holiday"));
		regOneTopDomain(qsl("homes"));
		regOneTopDomain(qsl("horse"));
		regOneTopDomain(qsl("host"));
		regOneTopDomain(qsl("hosting"));
		regOneTopDomain(qsl("house"));
		regOneTopDomain(qsl("how"));
		regOneTopDomain(qsl("ibm"));
		regOneTopDomain(qsl("ifm"));
		regOneTopDomain(qsl("immo"));
		regOneTopDomain(qsl("immobilien"));
		regOneTopDomain(qsl("industries"));
		regOneTopDomain(qsl("info"));
		regOneTopDomain(qsl("ing"));
		regOneTopDomain(qsl("ink"));
		regOneTopDomain(qsl("institute"));
		regOneTopDomain(qsl("insure"));
		regOneTopDomain(qsl("int"));
		regOneTopDomain(qsl("international"));
		regOneTopDomain(qsl("investments"));
		regOneTopDomain(qsl("irish"));
		regOneTopDomain(qsl("iwc"));
		regOneTopDomain(qsl("jcb"));
		regOneTopDomain(qsl("jetzt"));
		regOneTopDomain(qsl("jobs"));
		regOneTopDomain(qsl("joburg"));
		regOneTopDomain(qsl("juegos"));
		regOneTopDomain(qsl("kaufen"));
		regOneTopDomain(qsl("kddi"));
		regOneTopDomain(qsl("kim"));
		regOneTopDomain(qsl("kitchen"));
		regOneTopDomain(qsl("kiwi"));
		regOneTopDomain(qsl("koeln"));
		regOneTopDomain(qsl("krd"));
		regOneTopDomain(qsl("kred"));
		regOneTopDomain(qsl("kyoto"));
		regOneTopDomain(qsl("lacaixa"));
		regOneTopDomain(qsl("land"));
		regOneTopDomain(qsl("lat"));
		regOneTopDomain(qsl("latrobe"));
		regOneTopDomain(qsl("lawyer"));
		regOneTopDomain(qsl("lds"));
		regOneTopDomain(qsl("lease"));
		regOneTopDomain(qsl("legal"));
		regOneTopDomain(qsl("lgbt"));
		regOneTopDomain(qsl("lidl"));
		regOneTopDomain(qsl("life"));
		regOneTopDomain(qsl("lighting"));
		regOneTopDomain(qsl("limited"));
		regOneTopDomain(qsl("limo"));
		regOneTopDomain(qsl("link"));
		regOneTopDomain(qsl("loans"));
		regOneTopDomain(qsl("london"));
		regOneTopDomain(qsl("lotte"));
		regOneTopDomain(qsl("lotto"));
		regOneTopDomain(qsl("ltda"));
		regOneTopDomain(qsl("luxe"));
		regOneTopDomain(qsl("luxury"));
		regOneTopDomain(qsl("madrid"));
		regOneTopDomain(qsl("maison"));
		regOneTopDomain(qsl("management"));
		regOneTopDomain(qsl("mango"));
		regOneTopDomain(qsl("market"));
		regOneTopDomain(qsl("marketing"));
		regOneTopDomain(qsl("marriott"));
		regOneTopDomain(qsl("media"));
		regOneTopDomain(qsl("meet"));
		regOneTopDomain(qsl("melbourne"));
		regOneTopDomain(qsl("meme"));
		regOneTopDomain(qsl("memorial"));
		regOneTopDomain(qsl("menu"));
		regOneTopDomain(qsl("miami"));
		regOneTopDomain(qsl("mil"));
		regOneTopDomain(qsl("mini"));
		regOneTopDomain(qsl("mobi"));
		regOneTopDomain(qsl("moda"));
		regOneTopDomain(qsl("moe"));
		regOneTopDomain(qsl("monash"));
		regOneTopDomain(qsl("money"));
		regOneTopDomain(qsl("mormon"));
		regOneTopDomain(qsl("mortgage"));
		regOneTopDomain(qsl("moscow"));
		regOneTopDomain(qsl("motorcycles"));
		regOneTopDomain(qsl("mov"));
		regOneTopDomain(qsl("museum"));
		regOneTopDomain(qsl("nagoya"));
		regOneTopDomain(qsl("name"));
		regOneTopDomain(qsl("navy"));
		regOneTopDomain(qsl("net"));
		regOneTopDomain(qsl("network"));
		regOneTopDomain(qsl("neustar"));
		regOneTopDomain(qsl("new"));
		regOneTopDomain(qsl("nexus"));
		regOneTopDomain(qsl("ngo"));
		regOneTopDomain(qsl("nhk"));
		regOneTopDomain(qsl("nico"));
		regOneTopDomain(qsl("ninja"));
		regOneTopDomain(qsl("nra"));
		regOneTopDomain(qsl("nrw"));
		regOneTopDomain(qsl("ntt"));
		regOneTopDomain(qsl("nyc"));
		regOneTopDomain(qsl("okinawa"));
		regOneTopDomain(qsl("one"));
		regOneTopDomain(qsl("ong"));
		regOneTopDomain(qsl("onl"));
		regOneTopDomain(qsl("ooo"));
		regOneTopDomain(qsl("org"));
		regOneTopDomain(qsl("organic"));
		regOneTopDomain(qsl("osaka"));
		regOneTopDomain(qsl("otsuka"));
		regOneTopDomain(qsl("ovh"));
		regOneTopDomain(qsl("paris"));
		regOneTopDomain(qsl("partners"));
		regOneTopDomain(qsl("parts"));
		regOneTopDomain(qsl("party"));
		regOneTopDomain(qsl("pharmacy"));
		regOneTopDomain(qsl("photo"));
		regOneTopDomain(qsl("photography"));
		regOneTopDomain(qsl("photos"));
		regOneTopDomain(qsl("physio"));
		regOneTopDomain(qsl("pics"));
		regOneTopDomain(qsl("pictures"));
		regOneTopDomain(qsl("pink"));
		regOneTopDomain(qsl("pizza"));
		regOneTopDomain(qsl("place"));
		regOneTopDomain(qsl("plumbing"));
		regOneTopDomain(qsl("pohl"));
		regOneTopDomain(qsl("poker"));
		regOneTopDomain(qsl("porn"));
		regOneTopDomain(qsl("post"));
		regOneTopDomain(qsl("praxi"));
		regOneTopDomain(qsl("press"));
		regOneTopDomain(qsl("pro"));
		regOneTopDomain(qsl("prod"));
		regOneTopDomain(qsl("productions"));
		regOneTopDomain(qsl("prof"));
		regOneTopDomain(qsl("properties"));
		regOneTopDomain(qsl("property"));
		regOneTopDomain(qsl("pub"));
		regOneTopDomain(qsl("qpon"));
		regOneTopDomain(qsl("quebec"));
		regOneTopDomain(qsl("realtor"));
		regOneTopDomain(qsl("recipes"));
		regOneTopDomain(qsl("red"));
		regOneTopDomain(qsl("rehab"));
		regOneTopDomain(qsl("reise"));
		regOneTopDomain(qsl("reisen"));
		regOneTopDomain(qsl("reit"));
		regOneTopDomain(qsl("ren"));
		regOneTopDomain(qsl("rentals"));
		regOneTopDomain(qsl("repair"));
		regOneTopDomain(qsl("report"));
		regOneTopDomain(qsl("republican"));
		regOneTopDomain(qsl("rest"));
		regOneTopDomain(qsl("restaurant"));
		regOneTopDomain(qsl("reviews"));
		regOneTopDomain(qsl("rich"));
		regOneTopDomain(qsl("rio"));
		regOneTopDomain(qsl("rip"));
		regOneTopDomain(qsl("rocks"));
		regOneTopDomain(qsl("rodeo"));
		regOneTopDomain(qsl("rsvp"));
		regOneTopDomain(qsl("ruhr"));
		regOneTopDomain(qsl("ryukyu"));
		regOneTopDomain(qsl("saarland"));
		regOneTopDomain(qsl("sale"));
		regOneTopDomain(qsl("samsung"));
		regOneTopDomain(qsl("sarl"));
		regOneTopDomain(qsl("saxo"));
		regOneTopDomain(qsl("sca"));
		regOneTopDomain(qsl("scb"));
		regOneTopDomain(qsl("schmidt"));
		regOneTopDomain(qsl("school"));
		regOneTopDomain(qsl("schule"));
		regOneTopDomain(qsl("schwarz"));
		regOneTopDomain(qsl("science"));
		regOneTopDomain(qsl("scot"));
		regOneTopDomain(qsl("services"));
		regOneTopDomain(qsl("sew"));
		regOneTopDomain(qsl("sexy"));
		regOneTopDomain(qsl("shiksha"));
		regOneTopDomain(qsl("shoes"));
		regOneTopDomain(qsl("shriram"));
		regOneTopDomain(qsl("singles"));
		regOneTopDomain(qsl("sky"));
		regOneTopDomain(qsl("social"));
		regOneTopDomain(qsl("software"));
		regOneTopDomain(qsl("sohu"));
		regOneTopDomain(qsl("solar"));
		regOneTopDomain(qsl("solutions"));
		regOneTopDomain(qsl("soy"));
		regOneTopDomain(qsl("space"));
		regOneTopDomain(qsl("spiegel"));
		regOneTopDomain(qsl("style"));
		regOneTopDomain(qsl("supplies"));
		regOneTopDomain(qsl("supply"));
		regOneTopDomain(qsl("support"));
		regOneTopDomain(qsl("surf"));
		regOneTopDomain(qsl("surgery"));
		regOneTopDomain(qsl("suzuki"));
		regOneTopDomain(qsl("sydney"));
		regOneTopDomain(qsl("systems"));
		regOneTopDomain(qsl("taipei"));
		regOneTopDomain(qsl("tatar"));
		regOneTopDomain(qsl("tattoo"));
		regOneTopDomain(qsl("tax"));
		regOneTopDomain(qsl("technology"));
		regOneTopDomain(qsl("tel"));
		regOneTopDomain(qsl("temasek"));
		regOneTopDomain(qsl("tennis"));
		regOneTopDomain(qsl("tienda"));
		regOneTopDomain(qsl("tips"));
		regOneTopDomain(qsl("tires"));
		regOneTopDomain(qsl("tirol"));
		regOneTopDomain(qsl("today"));
		regOneTopDomain(qsl("tokyo"));
		regOneTopDomain(qsl("tools"));
		regOneTopDomain(qsl("top"));
		regOneTopDomain(qsl("toshiba"));
		regOneTopDomain(qsl("town"));
		regOneTopDomain(qsl("toys"));
		regOneTopDomain(qsl("trade"));
		regOneTopDomain(qsl("training"));
		regOneTopDomain(qsl("travel"));
		regOneTopDomain(qsl("trust"));
		regOneTopDomain(qsl("tui"));
		regOneTopDomain(qsl("university"));
		regOneTopDomain(qsl("uno"));
		regOneTopDomain(qsl("uol"));
		regOneTopDomain(qsl("vacations"));
		regOneTopDomain(qsl("vegas"));
		regOneTopDomain(qsl("ventures"));
		regOneTopDomain(qsl("versicherung"));
		regOneTopDomain(qsl("vet"));
		regOneTopDomain(qsl("viajes"));
		regOneTopDomain(qsl("video"));
		regOneTopDomain(qsl("villas"));
		regOneTopDomain(qsl("vision"));
		regOneTopDomain(qsl("vlaanderen"));
		regOneTopDomain(qsl("vodka"));
		regOneTopDomain(qsl("vote"));
		regOneTopDomain(qsl("voting"));
		regOneTopDomain(qsl("voto"));
		regOneTopDomain(qsl("voyage"));
		regOneTopDomain(qsl("wales"));
		regOneTopDomain(qsl("wang"));
		regOneTopDomain(qsl("watch"));
		regOneTopDomain(qsl("webcam"));
		regOneTopDomain(qsl("website"));
		regOneTopDomain(qsl("wed"));
		regOneTopDomain(qsl("wedding"));
		regOneTopDomain(qsl("whoswho"));
		regOneTopDomain(qsl("wien"));
		regOneTopDomain(qsl("wiki"));
		regOneTopDomain(qsl("williamhill"));
		regOneTopDomain(qsl("wme"));
		regOneTopDomain(qsl("work"));
		regOneTopDomain(qsl("works"));
		regOneTopDomain(qsl("world"));
		regOneTopDomain(qsl("wtc"));
		regOneTopDomain(qsl("wtf"));
		regOneTopDomain(qsl("xxx"));
		regOneTopDomain(qsl("xyz"));
		regOneTopDomain(qsl("yachts"));
		regOneTopDomain(qsl("yandex"));
		regOneTopDomain(qsl("yodobashi"));
		regOneTopDomain(qsl("yoga"));
		regOneTopDomain(qsl("yokohama"));
		regOneTopDomain(qsl("youtube"));
		regOneTopDomain(qsl("zip"));
		regOneTopDomain(qsl("zone"));
		regOneTopDomain(qsl("zuerich"));
		regOneTopDomain(qsl("xn--1qqw23a"));
		regOneTopDomain(qsl("xn--3bst00m"));
		regOneTopDomain(qsl("xn--3ds443g"));
		regOneTopDomain(qsl("xn--3e0b707e"));
		regOneTopDomain(qsl("xn--45brj9c"));
		regOneTopDomain(qsl("xn--45q11c"));
		regOneTopDomain(qsl("xn--4gbrim"));
		regOneTopDomain(qsl("xn--55qw42g"));
		regOneTopDomain(qsl("xn--55qx5d"));
		regOneTopDomain(qsl("xn--6frz82g"));
		regOneTopDomain(qsl("xn--6qq986b3xl"));
		regOneTopDomain(qsl("xn--80adxhks"));
		regOneTopDomain(qsl("xn--80ao21a"));
		regOneTopDomain(qsl("xn--80asehdb"));
		regOneTopDomain(qsl("xn--80aswg"));
		regOneTopDomain(qsl("xn--90a3ac"));
		regOneTopDomain(qsl("xn--90ais"));
		regOneTopDomain(qsl("xn--b4w605ferd"));
		regOneTopDomain(qsl("xn--c1avg"));
		regOneTopDomain(qsl("xn--cg4bki"));
		regOneTopDomain(qsl("xn--clchc0ea0b2g2a9gcd"));
		regOneTopDomain(qsl("xn--czr694b"));
		regOneTopDomain(qsl("xn--czrs0t"));
		regOneTopDomain(qsl("xn--czru2d"));
		regOneTopDomain(qsl("xn--d1acj3b"));
		regOneTopDomain(qsl("xn--d1alf"));
		regOneTopDomain(qsl("xn--fiq228c5hs"));
		regOneTopDomain(qsl("xn--fiq64b"));
		regOneTopDomain(qsl("xn--fiqs8s"));
		regOneTopDomain(qsl("xn--fiqz9s"));
		regOneTopDomain(qsl("xn--flw351e"));
		...
		regOneTopDomain(qsl("xn--hxt814e"));
		regOneTopDomain(qsl("xn--i1b6b1a6a2e"));
		regOneTopDomain(qsl("xn--io0a7i"));
		regOneTopDomain(qsl("xn--j1amh"));
		regOneTopDomain(qsl("xn--j6w193g"));
		regOneTopDomain(qsl("xn--kprw13d"));
		regOneTopDomain(qsl("xn--kpry57d"));
		regOneTopDomain(qsl("xn--kput3i"));
		...
		regOneTopDomain(qsl("xn--mgbab2bd"));
		...
		regOneTopDomain(qsl("xn--ngbc5azd"));
		regOneTopDomain(qsl("xn--node"));
		regOneTopDomain(qsl("xn--nqv7f"));
		regOneTopDomain(qsl("xn--nqv7fs00ema"));
		regOneTopDomain(qsl("xn--o3cw4h"));
		regOneTopDomain(qsl("xn--ogbpf8fl"));
		regOneTopDomain(qsl("xn--p1acf"));
		regOneTopDomain(qsl("xn--p1ai"));
		regOneTopDomain(qsl("xn--pgbs0dh"));
		regOneTopDomain(qsl("xn--q9jyb4c"));
		regOneTopDomain(qsl("xn--qcka1pmc"));
		regOneTopDomain(qsl("xn--rhqv96g"));
		regOneTopDomain(qsl("xn--s9brj9c"));
		regOneTopDomain(qsl("xn--ses554g"));
		regOneTopDomain(qsl("xn--unup4y"));
		regOneTopDomain(qsl("xn--vermgensberater-ctb"));
		regOneTopDomain(qsl("xn--vermgensberatung-pwb"));
		regOneTopDomain(qsl("xn--vhquv"));
		regOneTopDomain(qsl("xn--wgbh1c"));
		regOneTopDomain(qsl("xn--wgbl6a"));
		regOneTopDomain(qsl("xn--xhq521b"));
		...
		regOneTopDomain(qsl("xn--zfr164b"));
		regOneTopDomain(QString::fromUtf8("佛山"));
		regOneTopDomain(QString::fromUtf8("集团"));
		regOneTopDomain(QString::fromUtf8("在线"));
		regOneTopDomain(QString::fromUtf8("한국"));
		regOneTopDomain(QString::fromUtf8("ভারত"));
		regOneTopDomain(QString::fromUtf8("八卦"));
		regOneTopDomain(QString::fromUtf8("موقع"));
		regOneTopDomain(QString::fromUtf8("公益"));
		regOneTopDomain(QString::fromUtf8("公司"));
		regOneTopDomain(QString::fromUtf8("移动"));
		regOneTopDomain(QString::fromUtf8("我爱你"));
		regOneTopDomain(QString::fromUtf8("москва"));
		regOneTopDomain(QString::fromUtf8("қаз"));
		regOneTopDomain(QString::fromUtf8("онлайн"));
		regOneTopDomain(QString::fromUtf8("сайт"));
		regOneTopDomain(QString::fromUtf8("срб"));
		regOneTopDomain(QString::fromUtf8("бел"));
		regOneTopDomain(QString::fromUtf8("淡马锡"));
		regOneTopDomain(QString::fromUtf8("орг"));
		regOneTopDomain(QString::fromUtf8("삼성"));
		regOneTopDomain(QString::fromUtf8("சிங்கப்பூர்"));
		regOneTopDomain(QString::fromUtf8("商标"));
		regOneTopDomain(QString::fromUtf8("商店"));
		regOneTopDomain(QString::fromUtf8("商城"));
		regOneTopDomain(QString::fromUtf8("дети"));
		regOneTopDomain(QString::fromUtf8("мкд"));
		regOneTopDomain(QString::fromUtf8("中文网"));
		regOneTopDomain(QString::fromUtf8("中信"));
		regOneTopDomain(QString::fromUtf8("中国"));
		regOneTopDomain(QString::fromUtf8("中國"));
		regOneTopDomain(QString::fromUtf8("谷歌"));
		regOneTopDomain(QString::fromUtf8("భారత్"));
		regOneTopDomain(QString::fromUtf8("ලංකා"));
		regOneTopDomain(QString::fromUtf8("ભારત"));
		regOneTopDomain(QString::fromUtf8("भारत"));
		regOneTopDomain(QString::fromUtf8("网店"));
		regOneTopDomain(QString::fromUtf8("संगठन"));
		regOneTopDomain(QString::fromUtf8("网络"));
		regOneTopDomain(QString::fromUtf8("укр"));
		regOneTopDomain(QString::fromUtf8("香港"));
		regOneTopDomain(QString::fromUtf8("台湾"));
		regOneTopDomain(QString::fromUtf8("台灣"));
		regOneTopDomain(QString::fromUtf8("手机"));
		regOneTopDomain(QString::fromUtf8("мон"));
		regOneTopDomain(QString::fromUtf8("الجزائر"));
		regOneTopDomain(QString::fromUtf8("عمان"));
		regOneTopDomain(QString::fromUtf8("ایران"));
		regOneTopDomain(QString::fromUtf8("امارات"));
		regOneTopDomain(QString::fromUtf8("بازار"));
		regOneTopDomain(QString::fromUtf8("الاردن"));
		regOneTopDomain(QString::fromUtf8("بھارت"));
		regOneTopDomain(QString::fromUtf8("المغرب"));
		regOneTopDomain(QString::fromUtf8("السعودية"));
		regOneTopDomain(QString::fromUtf8("مليسيا"));
		regOneTopDomain(QString::fromUtf8("شبكة"));
		regOneTopDomain(QString::fromUtf8("გე"));
		regOneTopDomain(QString::fromUtf8("机构"));
		regOneTopDomain(QString::fromUtf8("组织机构"));
		regOneTopDomain(QString::fromUtf8("ไทย"));
		regOneTopDomain(QString::fromUtf8("سورية"));
		regOneTopDomain(QString::fromUtf8("рус"));
		regOneTopDomain(QString::fromUtf8("рф"));
		regOneTopDomain(QString::fromUtf8("تونس"));
		regOneTopDomain(QString::fromUtf8("みんな"));
		regOneTopDomain(QString::fromUtf8("グーグル"));
		regOneTopDomain(QString::fromUtf8("世界"));
		regOneTopDomain(QString::fromUtf8("ਭਾਰਤ"));
		regOneTopDomain(QString::fromUtf8("网址"));
		regOneTopDomain(QString::fromUtf8("游戏"));
		regOneTopDomain(QString::fromUtf8("vermögensberater"));
		regOneTopDomain(QString::fromUtf8("vermögensberatung"));
		regOneTopDomain(QString::fromUtf8("企业"));
		regOneTopDomain(QString::fromUtf8("مصر"));
		regOneTopDomain(QString::fromUtf8("قطر"));
		regOneTopDomain(QString::fromUtf8("广东"));
		regOneTopDomain(QString::fromUtf8("இலங்கை"));
		regOneTopDomain(QString::fromUtf8("இந்தியா"));
		regOneTopDomain(QString::fromUtf8("新加坡"));
		regOneTopDomain(QString::fromUtf8("فلسطين"));
		regOneTopDomain(QString::fromUtf8("政务"));
	}
