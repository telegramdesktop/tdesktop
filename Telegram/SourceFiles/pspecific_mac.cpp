...
PsMainWindow::PsMainWindow(QWidget *parent) : QMainWindow(parent), icon256(qsl(":/gui/art/iconround256.png")),
    trayIcon(0), trayIconMenu(0), posInited(false) {
...
void PsMainWindow::psNotify(History *history) {
