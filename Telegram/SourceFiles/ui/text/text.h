...
struct TextSelection
{
	...
	constexpr TextSelection(uint16 from, uint16 to) :
		from(from), to(to)
	{
	}
...
public:
	...
	bool lastDots(int32 dots, int32 maxdots = 3)
	{
		// hack for typing animation
...
inline bool chIsDiac(QChar ch)
{
	// diac and variation selectors
