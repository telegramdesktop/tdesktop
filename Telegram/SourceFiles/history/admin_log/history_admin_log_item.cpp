...
QString GenerateBannedChangeText(
	...
	static auto phraseMap = std::map<Flags, tr::phrase<>>{
		...
		{ Flag::f_send_stickers, tr::lng_admin_log_banned_send_stickers2 },
		{ Flag::f_send_gifs, tr::lng_admin_log_banned_send_gifs },
		{ Flag::f_send_inline, tr::lng_admin_log_banned_use_inline },
		{ Flag::f_send_games, tr::lng_admin_log_banned_send_games },
