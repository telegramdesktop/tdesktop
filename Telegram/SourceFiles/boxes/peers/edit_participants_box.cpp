...
void ParticipantsBoxController::prepare()
{
	const auto titleKey = [&]
	{
		...
		{
		case Role::Admins:
			return lng_channel_admins;
		case Role::Profile:
		case Role::Members:
			return lng_profile_participants_section;
		case Role::Restricted:
			return lng_exceptions_list_title;
		case Role::Kicked:
			return lng_removed_list_title;
		}
...
void ParticipantsBoxController::rebuildChatRows(not_null<ChatData*> chat)
{
	...
	case Role::Profile:
	case Role::Members:
		return rebuildChatParticipants(chat);
	case Role::Admins:
		return rebuildChatAdmins(chat);
	case Role::Restricted:
	case Role::Kicked:
