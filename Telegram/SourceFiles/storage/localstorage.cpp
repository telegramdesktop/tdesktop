...
namespace Local
{
	namespace
	{
		...
		void _readLocations()
		{
			...
			while (!locations.stream.atEnd())
			{
				...
				if (!first && !second && !legacyTypeField && loc.fname.isEmpty() && !loc.size)
				{
					// end mark
					endMarkFound = true;
					break;
			...
			case dbiWorkMode:
				{
					...
					auto newMode = [v]
					{
						...
						{
						case dbiwmTrayOnly:
							return dbiwmTrayOnly;
						case dbiwmWindowOnly:
							return dbiwmWindowOnly;
						};
			...
			case dbiNotifyView:
				{
					...
					case dbinvShowNothing:
						Global::SetNotifyView(dbinvShowNothing);
						break;
					case dbinvShowName:
						Global::SetNotifyView(dbinvShowName);
						break;
					default:
						Global::SetNotifyView(dbinvShowPreview);
						break;
					}
				}
				break;
			...
			case dbiRecentEmojiOldOld:
				{
					...
					if (!v.isEmpty())
					{
						...
						for (auto& item : v)
						{
							...
							{
							case 0xD83CDDEFLLU:
								oldKey = 0xD83CDDEFD83CDDF5LLU;
								break;
							case 0xD83CDDF0LLU:
								oldKey = 0xD83CDDF0D83CDDF7LLU;
								break;
							case 0xD83CDDE9LLU:
								oldKey = 0xD83CDDE9D83CDDEALLU;
								break;
							case 0xD83CDDE8LLU:
								oldKey = 0xD83CDDE8D83CDDF3LLU;
								break;
							case 0xD83CDDFALLU:
								oldKey = 0xD83CDDFAD83CDDF8LLU;
								break;
							case 0xD83CDDEBLLU:
								oldKey = 0xD83CDDEBD83CDDF7LLU;
								break;
							case 0xD83CDDEALLU:
								oldKey = 0xD83CDDEAD83CDDF8LLU;
								break;
							case 0xD83CDDEELLU:
								oldKey = 0xD83CDDEED83CDDF9LLU;
								break;
							case 0xD83CDDF7LLU:
								oldKey = 0xD83CDDF7D83CDDFALLU;
								break;
							case 0xD83CDDECLLU:
	...
	void writeInstalledStickers()
	{
		...
		{
			if (set.id == Stickers::CloudRecentSetId || set.id == Stickers::FavedSetId)
			{
			...
			else if (set.flags & MTPDstickerSet_ClientFlag::f_special)
			{
				...
				{
					// all other special are "installed"
					return StickerSetCheckResult::Skip;
				}
			}
			...
			else if (set.flags & MTPDstickerSet_ClientFlag::f_not_loaded)
			{
				// waiting to receive
